  ...
  <div>
    ...
    <article v-else>
                ...
                <figure class="media-left" v-if="question.userId">
                  <p class="is-size-7" v-if="isAuthorize">
                    ...
                    <a @click.prevent="deleteQuestion"
                      href="" class="button is-danger is-size-7">
                        delete
                    </a>
                  </p>
                </figure>
      ...
      <div class="columns">
        ...
        <div class="column">
          <a @click.prevent="postAnswer" class="button is-success is-size-7 is-pulled-right">
            Give Answer
          </a>
        </div>
      </div>
    ...
    <article>
    <AnswerBox v-for="(answer, index) in question.answers"
      :key="answer._id" :answer="answer" :index="index"
      @edit-answer="editAnswer($event)">
      </AnswerBox>
    </article>
    <footer>
      <a href="" @click.prevent="scrollUp"><i class="fas fa-chevron-up fa-3x"></i></a>
    </footer>
  </div>
</template>
...
export default {
  name: 'questionDetail',
  components: {
    Loading, AnswerBox, FormComponent,
  },
  created() {
